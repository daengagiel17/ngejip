...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Data Transaksi <small>{{$transaksis->count()}} transaksi</small></h1>
      <ol class="breadcrumb">
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          ...
          <div class="info-box">
            <a href="{{ route('transaksi.settlement') }}">
            <span class="info-box-icon bg-green"><i class="fa fa-check-circle"></i></span>
            </a>
            <div class="info-box-content">
              <span class="info-box-text">Success</span>
              <span class="info-box-number">{{$jmlh_settlement}} transaksi</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            <a href="{{ route('transaksi.expire') }}">
            <span class="info-box-icon bg-aqua"><i class="fa fa-ban"></i></span>
            </a>
            <div class="info-box-content">
              <span class="info-box-text">Expire</span>
              <span class="info-box-number">{{$jmlh_expire}} transaksi</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">{{$jmlh_pending}} transaksi</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Daftar Transaksi Keseluruhan</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
