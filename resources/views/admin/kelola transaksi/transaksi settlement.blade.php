...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Data Transaksi Settlement<small>{{$jumlah}} transaksi</small></h1>
      <ol class="breadcrumb">
        <li><a href="{{route('admin')}}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="{{ route('transaksi.index') }}">Data Transaksi</a></li>
        <li class="active">Data Transaksi Settlement</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Daftar Transaksi Settlement</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
