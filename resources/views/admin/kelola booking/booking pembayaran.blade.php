...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Data Booking Pembayaran<small>( {{$booking->count()}} booking )</small></h1>
      <ol class="breadcrumb">
        <li><a href="{{route('admin')}}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="{{route('booking.index')}}">Data Booking</a></li>
        <li class="active">Data Booking Pembayaran</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Daftar Booking Pembayaran</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
